...
public class LoginPageTest extends TestBase {
        ...
        @Description("""
                        Verify that the XYZ Bank login page loads and displays the main bank branding.
        ...
        @Description("""
                        Verify that the Customer Login button is visible and properly located on the main page.
        ...
        @Severity(SeverityLevel.CRITICAL)
        @Description("""
                        Verify that the Bank Manager Login button is visible and properly located on the main page.
        ...
        @Severity(SeverityLevel.CRITICAL)
        @Description("""
                        Verify that clicking the Customer Login button successfully redirects to the selection form.
        ...
        @Severity(SeverityLevel.CRITICAL)
        @Description("""
                        Verify that clicking the Bank Manager Login button successfully redirects to the manager interface.
